...
<div class="card-body">
    ...
    <form action="{{Route('nuevoAction')}}" enctype="multipart/form-data" method="POST" autocomplete="off">
            <div class="form-group row">
                ...
                <div class="col-6">
                    ...
                    <div id="the-basics">
                        <input class="typeahead"  name="nombre" type="text" value="">
                ...
                <div class="col-6">
                    ...
                    <div id="bloodhound">
                        <input class="typeahead"  name="descripcion" type="text" value="">
                 ...
                 <div class="col-6">
                    ...
                    <div id="bloodhound">
                        <input class="typeahead"  name="imagenes" type="text" value="">
                ...
                <div class="col-6">
                   ...
                   <label>
                       Servicios
                    		...
                    		<input class="typeahead"  name="servicios" type="text" value="">
                 ...
                 <div class="col-6">
                   ...
                   <label>
                       Direccion
                    		...
                    		<input class="typeahead"  name="direccion" type="text" value="">
                 ...
                 <div class="col-6">
                   ...
                   <label>
                       Telefono
                    		...
                    		<input class="typeahead"  name="telefono" type="text" value="">
                 ...
                 <div class="col-6">
                   ...
                   <label>
                       Horario
                    		...
                    		<input class="typeahead"  name="horario" type="text" value="">
                ...
                <div class="col-12 mt-5 row " style="justify-content: center;">
                                ...
                                <input class="btn btn-info" name="actualizar"  type="submit" value="Crear">
